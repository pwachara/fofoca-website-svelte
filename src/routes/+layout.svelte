	...
	<svelte:fragment slot="header">
		...
		<AppBar>
			<svelte:fragment slot="lead">
				<img src="./logo-loka-yellow.png" alt="logo" class="w-20 ml-16" />
			</svelte:fragment>
			<svelte:fragment slot="trail">
				<div class="flex gap-5 mr-16">
				<ul class="list gap-5 hidden lg:flex">
					<li class=" hover:text-[#ffff02] hover:cursor-pointer">
					...
					<li class=" hover:text-[#ffff02] hover:cursor-pointer">
						<a class:active={ $page.url.hash === "/about"} href="/about" aria-label="about">About</a>
					</li>
				</ul>
				<a
					class="btn btn-sm variant-ghost-surface hover:text-[#ffff01]"
