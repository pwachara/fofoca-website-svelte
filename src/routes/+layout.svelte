...
<Drawer zIndex=0 on:backdrop={ toggleMenu } opacityTransition={true} transitions duration={500}>
	<ul class="mt-64 flex flex-col justify-center items-center text-3xl gap-y-10 text-white">
		...
		<li class=" hover:text-[#fbbf24] hover:cursor-pointer">
			<a class:active={ $page.url.hash === "#team"} href="/#team" aria-label="contact" on:click={closeMenuLayout}>Team</a>
		</li>
		<li class=" hover:text-[#fbbf24] hover:cursor-pointer">
	...
	<svelte:fragment slot="header">
		...
		<AppBar>
			<svelte:fragment slot="lead">
				{#if menuOpen}
					<button class="ml-4 text-3xl lg:hidden" on:click={ closeMenuLayout }>&#10005</button>
				{:else}
					<button class="ml-4 text-3xl lg:hidden" on:click={ openMenuLayout }>&#9776</button>
				{/if}
			...
			<svelte:fragment slot="trail">
				...
				<ul class="list gap-5 hidden lg:flex mr-5">
					...
					<li class=" hover:text-[#fbbf24] hover:cursor-pointer">
						<a class:active={ $page.url.hash === "#team"} href="/#team" aria-label="contact">Team</a>
					</li>
					<li class=" hover:text-[#fbbf24] hover:cursor-pointer">
